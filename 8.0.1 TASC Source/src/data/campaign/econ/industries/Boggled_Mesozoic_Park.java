...
public class Boggled_Mesozoic_Park extends BaseIndustry
{
    ...
    public boolean isAvailableToBuild()
    {
        ...
        if(!Global.getSettings().getBoolean("boggledMesozoicParkEnabled") || !Global.getSettings().getBoolean("boggledTerraformingContentEnabled"))
        {
            return false;
        }
    ...
    @Override
    public float getPatherInterest() { return super.getPatherInterest() + 2f; }
}
