...
public class Boggled_AI_Mining_Drones extends BaseIndustry
{
    ...
    {
        if(Global.getSettings().getBoolean("boggledStationConstructionContentEnabled") && Global.getSettings().getBoolean("boggledEnableAIMiningDronesStructure") && this.market.getPrimaryEntity() != null && this.market.getPrimaryEntity().hasTag("station"))
        {
            return true;
        }
        else
