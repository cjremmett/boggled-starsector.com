...
{
    private float creditCost = Global.getSettings().getInt("boggledStationRecolonizeCreditCost");
    private float crewCost = Global.getSettings().getInt("boggledStationRecolonizeCrewCost");
    private float heavyMachineryCost = Global.getSettings().getInt("boggledStationRecolonizeHeavyMachineryCost");
    private float metalCost = Global.getSettings().getInt("boggledStationRecolonizeMetalCost");
    private float transplutonicsCost = Global.getSettings().getInt("boggledStationRecolonizeTransplutonicsCost");
