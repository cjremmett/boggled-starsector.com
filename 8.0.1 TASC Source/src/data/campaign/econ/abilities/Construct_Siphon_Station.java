...
{
    private float creditCost = Global.getSettings().getInt("boggledSiphonStationBuildCreditCost");
    private float crewCost = Global.getSettings().getInt("boggledSiphonStationBuildCrewCost");
    private float heavyMachineryCost = Global.getSettings().getInt("boggledSiphonStationBuildHeavyMachineryCost");
    private float metalCost = Global.getSettings().getInt("boggledSiphonStationBuildMetalCost");
    private float transplutonicsCost = Global.getSettings().getInt("boggledSiphonStationBuildTransplutonicsCost");
    ...
    protected void activateImpl()
    {
        ...
        newSiphonStation.setInteractionImage("illustrations", "orbital_construction");
