...
public class boggledInactiveGateCheckEnabled extends BaseCommandPlugin
{
    ...
    public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Misc.Token> params, Map<String, MemoryAPI> memoryMap)
    {
        ...
        if(Global.getSettings().getBoolean("boggledDomainTechContentEnabled") && Global.getSettings().getBoolean("boggledDomainTechInactiveGateConstructionEnabled"))
        {
            if(Global.getSettings().getBoolean("boggledDomainTechInactiveGateConstructionMainQuestCompletionRequired"))
            {
